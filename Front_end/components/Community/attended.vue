<template>
  <v-container>
        <v-row no-gutters justify="center" align="center">
         ...
         <v-col cols="3" md="3">
             <h5 style="font-size: 15px;font-family: 'Montserrat', sans-serif;">Bill<v-icon right small>mdi-arrow-down</v-icon></h5>
         </v-col>
  ...
  <div v-for="user in citizens" :key="user.id"  class="details mt-3">
      ...
      <v-row  no-gutters justify="center" align="center">
          ...
          >
           <v-row v-if="user.isibo" no-gutters justify="center" align="center">
               <v-col
                cols="2"
                md="2"
                sm="2"
               ...
               >
                   ...
                   <v-chip medium color="rgb(214, 157, 214)">
                    <v-icon small left>mdi-arrow-right</v-icon>
                  <h5 style="font-family: 'Montserrat', sans-serif;">{{user.charges}} Rwf</h5>
                  </v-chip>
               ...
               <v-col
                ...
                md="2"
               >
                 <v-btn :to="'/Leader/citizen/'+ user._id" small fab color="rgb(212, 177, 212)">
