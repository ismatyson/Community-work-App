<template>
  <v-container>
    ...
    <v-divider/>
     <v-row no-gutters justify="center" align="center">
         <v-col class="ml-2" cols="10" md="9">
             <h5 style="font-size: 35px;font-family: 'Montserrat', sans-serif;">Citizens who missed for {{post.event}} event<v-icon right small>mdi-arrow-down</v-icon></h5>
    ...
    <v-divider class="mt-2"/>
        <v-row no-gutters justify="center" align="center">
         ...
         <v-col class="ml-2" cols="3" md="3">
             <h5 style="font-size: 15px;font-family: 'Montserrat', sans-serif;">Missed<v-icon right small>mdi-arrow-down</v-icon></h5>
         </v-col>
  ...
  <div v-for="user in post.missed" :key="user.id"  class="details mt-3">
          ...
          >
           <v-row no-gutters justify="center" align="center">
               ...
               <v-col cols="3" md="3" sm="3">
                 ...
                 <h5 style="font-size: 13px;font-family: 'Montserrat', sans-serif;">{{user.missed}} time(s)</h5>
                   </v-chip>
               </v-col>
